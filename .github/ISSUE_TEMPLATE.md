...
+ These "Issues" are meant for grammar/spelling/syntax, technical problems, bugs, and proposals related to the library, although, exceptions are made for noteworthy cases. If you're reporting a bug, please use the below bug template.

(BUG TEMPLATE):
#### What's your environment and browser:
#### Expected behavior:
#### Actual behavior:
