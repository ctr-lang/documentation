...
__Description__: The `appendTo` option property appends its value to the scope `<identifier>`.

{!transition/target-option/_code/appendTo.code.md!}
{!transition/target-option/_code/appendTo.fixture.md!}
